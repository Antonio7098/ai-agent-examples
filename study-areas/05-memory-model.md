...
| Score | Meaning                                                  |
| ----- | --------------------------------------------------------|
| 1–3   | No persistent memory, context is the only store         |
| 4–6   | Basic session memory with simple pruning                 |
| 7–8   | Structured memory with summarization and retrieval        |
| 9–10  | Sophisticated multi-layer memory with RAG and persistence |

Fast heuristic:

> "Can you ask the agent what it did in a previous session?"
