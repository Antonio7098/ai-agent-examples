...
| Score | Meaning |
| ----- | ------ |
| 1–3   | No context management, everything in every turn |
| 4–6   | Basic sliding window with hard truncation |
| 7–8   | Structured context with summarization and relevance filtering |
| 9–10  | Sophisticated context engineering with compression, retrieval, and cost optimization |

Fast heuristic:

> "Does the agent remember the right things and forget the noise?"
